 ...
 *
 */
class Mediasharex_Handler_ModifyStoreItem extends Zikula_Form_AbstractHandler
{
    var $id;
    var $item;
    ...
    public function initialize(Zikula_Form_View $view)
    {
		...
		$item_file = new Mediasharex_Manager_MediaStoreItem($item['originalId']);
		$item_file_arr = $item_file->getItemArray();		
		$view->assign('item_file_arr',$item_file_arr);

...
class Mediasharex_Access_Simple {
   ...
   public function getAlbumAccess($album) 
	...
	$access['see'] = Mediasharex_Util_Access::checkPerms(ACCESS_OVERVIEW, '::');
	$access['read'] = Mediasharex_Util_Access::checkPerms(ACCESS_READ, '::');
	$access['comment'] = Mediasharex_Util_Access::checkPerms(ACCESS_COMMENT, '::');
	$access['moderate'] = Mediasharex_Util_Access::checkPerms(ACCESS_MODERATE, '::');	
	$access['edit'] = Mediasharex_Util_Access::checkPerms(ACCESS_EDIT, '::');
	$access['add'] = Mediasharex_Util_Access::checkPerms(ACCESS_ADD, '::');
	$access['add_media'] = Mediasharex_Util_Access::checkPerms(ACCESS_ADD, '::');
	$access['add_albums'] = Mediasharex_Util_Access::checkPerms(ACCESS_ADD, '::');
	$access['access'] = Mediasharex_Util_Access::checkPerms(ACCESS_MODERATE, '::');			
	$access['delete'] = Mediasharex_Util_Access::checkPerms(ACCESS_DELETE, '::');		
	$access['admin'] = Mediasharex_Util_Access::checkPerms(ACCESS_ADMIN, '::');		


	//owner access
	$access['owner'] = ($album['author'] == UserUtil::getVar('uid')) ? true : false ;	
	$access['edit'] = $access['owner'] || $access['edit']; 	
	$access['add_media'] = $access['owner'] || $access['add_media']; 
	$access['add_albums'] = $access['owner'] || $access['add_albums']; 
	$access['access'] = $access['owner'] || $access['access'];	

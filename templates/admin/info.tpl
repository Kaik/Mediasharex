...
<div class="z-admin-content-pagetitle">
    ...
    <h3>{gt text="Informations about Mediasharex installation"}</h3>
</div>
...
<div id="mediasharex_info" class="z-clearfix">
    <div id="mediasharex_info_" class="z-clearfix">
      <div id="mediasharex_install_status" class="z-w40 z-formrow z-floatleft">  
        ...
        <p>{gt text="mediaDirName"}: {if $dir_check.mediaDirName.writable} {icon type="ok" size="extrasmall"} {gt text="Directory exist and is writable"} {elseif $dir_check.mediaDirName.writable == false} {icon type="cancel" size="extrasmall"} {gt text="Directory not exist or is not writable"}{/if}</p> 
        <p>{gt text="tmpDirName"}: {if $dir_check.tmpDirName.writable} {icon type="ok" size="extrasmall"} {gt text="Directory exist and is writable"} {elseif $dir_check.tmpDirName.writable == false} {icon type="cancel" size="extrasmall"} {gt text="Directory not exist or is not writable"}{/if}</p> 

...
<div class="z-admin-content-pagetitle">
    ...
    <h3>{gt text="Manage sources"}</h3>
</div>

<div class="z-informationmsg">
<a href="{modurl modname='Mediasharex' type='admin' func='reloadsources'}"> {icon type="regenerate" size="extrasmall"} {gt text="Reload sources"}</a> 
</div>

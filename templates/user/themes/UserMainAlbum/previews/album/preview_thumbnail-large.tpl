  ...
  <div class="mediasharex_preview_album_thumbnail-large_image_box" style="height:{$c_preview_data.height}px;width:{$c_preview_data.width}px;" >          
      <div class="mediasharex_preview_album_thumbnail-large_image_icon mediasharex-icon-folder-close" style="font-size:{$c_preview_data.height+40}px;">   
      </div>

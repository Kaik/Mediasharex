  <div class="z-w50 z-floatleft mediasharex_preview_media_thumbnail-large z-clearfix"> 
<div class="mediasharex_preview_media_thumbnail-large_image" style="height:{$c_preview_data.height}px;width:{$c_preview_data.width}px"> 
...
<div class="mediasharex_preview_media_thumbnail-large_right">
<p class="mediasharex_preview_media_thumbnail-large_info">
...
<p class="mediasharex_preview_media_thumbnail-large_title">{$mediaitem.title}</p>
<p class="mediasharex_preview_media_thumbnail-large_description">{$mediaitem.description}</p>     
</div>
</div>
...
<a  href="{modurl modname='Mediasharex' type='user' func='home'}" > <h1><i class="icon-picture icon-2x"></i> {gt text="Gallery"}</h1></a>
</li> 
<li id="add_link">  
        <a  title="{gt text='Newest'}" class="tip" href="{modurl modname='Mediasharex' type='user' func='view'}"><i class="icon-star icon-large"></i> {gt text='Newest'}</a>
</li> 
<li id="add_link">  
        <a  title="{gt text='Browse'}" class="tip" href="{modurl modname='Mediasharex' type='user' func='display'}"><i class="icon-sitemap icon-large"></i> {gt text='Browse'}</a>
</li> 

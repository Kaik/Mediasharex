...
<li id="add_link">  
        <a  title="{gt text='Newest'}" class="tip" href="{modurl modname='Mediasharex' type='user' func='view'}"><i class="mediasharex-icon-star mediasharex-icon-large"></i> {gt text='Newest'}</a>
</li> 
<li id="add_link">  
        <a  title="{gt text='Browse'}" class="tip" href="{modurl modname='Mediasharex' type='user' func='display'}"><i class="mediasharex-icon-sitemap mediasharex-icon-large"></i> {gt text='Browse'}</a>
</li> 
